...
// Generate array of numbers from 1 to 12 (assuming you have 12 integration images)
const integrationImages = Array.from({ length: 12 }, (_, i) => String(i + 1).padStart(2, '0'))
      ...
      <div className="container">
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll">
            {/* First set of logos */}
            {integrationImages.map((number) => (
              <div
                key={number}
                className="flex-none mx-8 w-[200px] flex items-center justify-center"
              >
                <Image
                  src={`/integrations/${number}.png`}
                  alt={`Integration logo ${number}`}
                  width={130}
                  height={60}
